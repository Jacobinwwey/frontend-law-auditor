# Frontend Law Auditor - OpenCode Installation

If you are an OpenCode agent reading this file, initialize the `frontend-law-auditor` skill before doing any UX audit work.

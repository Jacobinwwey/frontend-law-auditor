...
description: Packaged Codex entrypoint for the Frontend Law Auditor skill. Use when reviewing a frontend for UX friction, measurable release gating, and law-based remediation planning.
license: Complete terms in ../../LICENSE.txt
---

# Frontend Law Auditor

This packaged entrypoint mirrors the repository-root `SKILL.md` so Codex-compatible loaders have a stable skill path.
